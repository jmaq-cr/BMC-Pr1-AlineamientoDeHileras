...
def water(s1, s2):
    ...
    for i in range(1, m + 1):
        for j in range(1, n + 1):
            ...
            if getValue(H,i,j) == 0: T = setValue(T,i,j,0)
            if getValue(H,i,j) == sc_left: T = setValue(T,i,j,1)
            if getValue(H,i,j) == sc_up: T = setValue(T,i,j,2)
            if getValue(H,i,j) == sc_diag: T = setValue(T,i,j,3)
